...
\begin{enumerate}
 ...
 \item Es wäre notwendig, dass der Fehlerzustand auf das Event für die steigende Flanke der Rutschenlichtschranke reagiert. Hierzu muss ein passender Handler geschrieben werden, der den Zustand der Ampel ändert.
 \item In seltenen Fällen werden Interrupts von der Software nicht erkannt. Dies könnte einem Fehler in der ISR geschuldet sein und würde weitere Prüfung benötigen.
\end{enumerate}
