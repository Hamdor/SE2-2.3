...
\begin{small}
  \begin{center}
    \begin{longtable}{|c|p{4cm}|p{6cm}|C{3cm}|}
      ...
      \hline
      TF05 & Ein Nicht-Metall- und ein Metall-Puck werden auf B1 gelegt. Nach der Weiche wird der zweite Puck entfernt. & Das Band hält an und die Ampel von B1 blinkt rot. & FR-004, FR-006.1, FR-006.2, FR-011, FR-016, FR-017, FR-019.1, FR-019.2, FR-019.3, FR-019.4, FR-019.5, FR-023\\
      \hline
