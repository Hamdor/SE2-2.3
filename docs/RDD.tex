...
\date{\today\thanks{Dokument-Version: 1.1}} % ! Hier die Versionsnummer an Versionshistorie anpassen !
\maketitle
...
\begin{small}
  \begin{center}
    \begin{tabular}{|c|c|c|p{7.25cm}|}
      ...
      \hline
      1.1 & Marian Triebe & 18.12.2014 & Visionen zur Behebung der Mängel hinzugefügt\\
      \hline
    \end{tabular}
  \end{center}
\end{small}
...
\begin{figure}[p]
  ...
  \centering\includegraphics[angle=90,scale=0.6]{imgs/Band1_FSM.png}
...
\begin{figure}[p]
  ...
  \centering\includegraphics[angle=90,scale=0.56]{imgs/Error_FSM.png}
...
\begin{figure}[p]
  ...
  \centering\includegraphics[angle=90,scale=0.95]{imgs/Req_Test_Abdeckung_1.png}
...
\begin{figure}[p]
  ...
  \centering\includegraphics[angle=90,scale=0.95]{imgs/Req_Test_Abdeckung_2.png}
...
\begin{figure}[p]
  ...
  \centering\includegraphics[angle=90,scale=0.95]{imgs/Req_Test_Abdeckung_3.png}
...
\subsubsection{Visionen zur Behebung der Mängel}
Die Nummerierung der Mängel wie aus der vorherigen Sektion (8.7 Abnahmeprotokoll vom 18.12.2014).
\begin{enumerate}
 \item Das entfernte Werkstück sollte sensitiv auf das Event für die steigende Flanke der Ausgangslichtschranke sein. Der Zustand in dem sich das Werkstück zu diesem Zeitpunkt befand, sollte außerdem ein Handler für dieses Event bereitstellen.
 \item Es wäre notwendig, dass der Fehlerzustand auf das Event für die steigende Flanke der Lichtschranke der Rutsche reagiert. Hierzu muss ein passender Handler geschrieben werden, der den Zustand der Ampel ändert.
 \item In seltenen Fällen werden Interrupts von der Software nicht erkannt. Dies könnte einem Fehler in der ISR geschuldet sein und würde einer weiterer Prüfung benötigen.
\end{enumerate}
