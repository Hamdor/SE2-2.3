...
\begin{small}
 \begin{tabular}{|c|c|c|L{6cm}|}
  ...
  \hline
   ...
   \hline
   0.93 & Marian Triebe & 13.12.2014 & Regressionstests aktualisiert, Lessons Learned begonnen\\
   \hline
 \end{tabular}
\end{small}
...
\begin{enumerate}
 ...
 \item Test der Timer
 \begin{enumerate}
  \item Ein normaler Timer wird erstellt, dieser soll nach 1ner Millisekunde einen Wert in einen Pulse Message Channel schreiben. Der Wert der Pulse Message wird geprüft.
  \item Ein Timer mit kurzer Laufzeit und ein zweiter Timer mit längerer Laufzeit wird erstellt. Der erste Timer wird pausiert. Es wird blockiert bis eine Pulse
  Message vorhanden ist. Danach wird der kurze Timer fortgesetzt und auf die Pulse Message gewartet.
  \item Es werden 3 Timer erstellt. Einer mit 500 Millisekunden Laufzeit, einer mit 1 Sekunden Laufzeit, sowie einer mit 3 Sekunden. Nachdem alle gestartet sind, wird
  dem 500 Millisekunden Timer 1 Sekunde hinzugefügt. Die korrekte Reihenfolge der Pulse Messages wird ausgewertet.
 \end{enumerate}
 \item Test der Seriellen Schnittstelle
 \begin{enumerate}
  \item Senden/Empfangen eines Datentelegrams
...
\newline
04.12.2014: Fehlerhaftes Aussortieren von zu großen Werkstücken. Werkstück Anodrnung: Korrekte Höhe, falsche Höhe.\\
\newline
...
\newline
08.12.2014: Ein Fehler der Aussortierung wurde behoben. Dieser Fehler wurde ausgelöst dadurch, dass das zu kleine Werkstück (welches auf dem Band vor dem korrekten Werkstück liegt)
...
Das Klima im Team war sehr angenehm, wahrscheinlich etwas zu freundlich. Es kam leider nicht zu Architekturdiskussionen,
was Fehler von vorneherein hätte vermeiden können. Als die Fehler aufkamen war es teilweise schon zu spät grundlegende
Änderungen vornehmen zu können, was zu kleineren Workarounds geführt hat. Es hat sich herausgestellt, dass es extrem schwierig ist
das Team zu organisieren wenn die Wissenstände zu unterschiedlich sind.
