...
\begin{small}
 \begin{longtable}{|p{2cm}|p{4cm}|p{1.5cm}|p{5.5cm}|}
  ...
  \hline
  \rowcolor{lightgray} NFR-004.2 & Timer für die Beförderung eines Werkstücks durch die Werkstück"=Sortieranlage & Sensorik & Eine Laufzeitmessung durch die Lichtschranken von weniger 6 Sekunden bedeutet, dass ein weiteres Werkstück unter Fremdeinwirkung auf das Band gelegt worden ist. Das Band wird angehalten und es wird eine Fehlermeldung ausgelöst.\\
  \hline
...
\begin{figure}
	...
	\centering\vfill\includegraphics[angle=90,scale=0.58]{imgs/Band1_FSM.png}
\end{figure}

% 6.3.2 Automat für Band 2
\begin{figure}
	\subsubsection{Automat für Band 2}
	\centering\vfill\includegraphics[angle=0,scale=0.46]{imgs/Band2_FSM.png}
...
% 8.4.1 Auflistung der Tests für die Grundfunktionen
...
% 8.4.2 Auflistung der Tests für die Fehlerfälle
...
\begin{small}
  \begin{longtable}{|C{1.5cm}|L{4cm}|L{4.5cm}|C{3.0cm}|}
    ...
    \hline
    \rowcolor{lightgray} TF02 & Ein Nicht-Metall-Puck wird auf B1 gelegt. Der Puck wird auf B2 vor der Höhenmessung entfernt. & Das Band hält an und die Ampel von B1 blinkt rot. & FR-004, FR-010, FR-011, FR-016, FR-019.1, FR-019.2, FR-019.3, FR-019.5, FR-021, FR-025, FR-029.1, FR-029.2, NFR-004.1, NFR-004.3\\
    \hline
...
das Team zu organisieren wenn die Wissensstände zu unterschiedlich sind.
