...
#if defined(FESTO_5)
#define SEGMENT1__SEC 3
#define SEGMENT1_NSEC 314492805
#define SEGMENT2__SEC 0
#define SEGMENT2_NSEC 769882190
#define SEGMENT3__SEC 2
#define SEGMENT3_NSEC 276651619
#define HEIGHT_TIME_OFFSET_SEG1_NSEC 509075123 + 10 * MILISEC_TO_NANOSEC
#endif

#if defined(FESTO_9)
#define SEGMENT1__SEC 3
#define SEGMENT1_NSEC 201510094
#define SEGMENT2__SEC 0
#define SEGMENT2_NSEC 857868726
#define SEGMENT3__SEC 2
#define SEGMENT3_NSEC 479620560
#define HEIGHT_TIME_OFFSET_SEG1_NSEC 158128826
#endif
...
#define OFFSET_CHECK_TIMES_SEG2_MSEC 850 * MILISEC_TO_NANOSEC

#define OFFSET_CHECK_TIMES_SEG3__SEC 0
#define OFFSET_CHECK_TIMES_SEG3_MSEC 950 * MILISEC_TO_NANOSEC

#define SEGMENT1_SEC__HAS_TO_EXPIRE SEGMENT1__SEC
#define SEGMENT1_MSEC_HAS_TO_EXPIRE SEGMENT1_NSEC / 1000000 - 50

#define SEGMENT1_SEC__TOO_LATE SEGMENT1__SEC + 0
#define SEGMENT1_MSEC_TOO_LATE SEGMENT1_NSEC / 1000000 + 50

#define SEGMENT2_SEC__HAS_TO_EXPIRE SEGMENT2__SEC
#define SEGMENT2_MSEC_HAS_TO_EXPIRE SEGMENT2_NSEC / 1000000 - 200

#define SEGMENT2_SEC__TOO_LATE SEGMENT2__SEC
#define SEGMENT2_MSEC_TOO_LATE SEGMENT2_NSEC / 1000000 + 50

#define SEGMENT3_SEC__HAS_TO_EXPIRE SEGMENT3__SEC
#define SEGMENT3_MSEC_HAS_TO_EXPIRE SEGMENT3_NSEC / 1000000 - 200

#define SEGMENT3_SEC__TOO_LATE SEGMENT3__SEC
#define SEGMENT3_MSEC_TOO_LATE SEGMENT3_NSEC / 1000000 + 50
